...
function App(){
  ...
  <Allelement active={active}>
  <Header handleuser={handleuser} initialname={initialname} />
  <Categories initialvalue={initialvalue} cartitem={cartitem} />
  <Outlet />
  <Footer />
  </Allelement>
  {active ? <Login handledelete={handledelete} handlenamea={handlenamea} /> : null}
